...
const DATA: AreaInfo[] = [
  ...
  {
    id: '5',
    title: 'পাবনা এক্সপ্রেস কাউন্টার (ঢাকা)',
    category: Category.BUS_COUNTER,
    description: 'পাবনা এক্সপ্রেসের ঢাকা অঞ্চলের সকল গুরুত্বপূর্ণ কাউন্টার নম্বরসমূহ। যাত্রী সাধারণের সুবিধার জন্য ঢাকা শহর এবং এর আশেপাশের এলাকার নম্বরগুলো এখানে দেওয়া হলো। নিরাপদ ও আরামদায়ক ভ্রমণের জন্য কাউন্টারে যোগাযোগ করে টিকেট বুকিং করতে পারেন।',
    addresses: ['গাবতলী, ঢাকা', 'সায়েদাবাদ, ঢাকা', 'উত্তরা, ঢাকা'],
    contacts: [
      '01718507828', '01799624848', '01799627540', '01799624852', '01742627173', 
      '01799624880', '01799624846', '01799624847', '01799624849', '01799624850', 
      '01799624851', '01799624881', '01799624882'
    ],
  ...
  },
  {
    ...
    contacts: [
      '01750143092', '01725442643', '01725442645', '01725442646', 
...
const DetailView: React.FC<{ 
  ...
  const getContactLabel = (num: string, itemId: string) => {
    ...
    if (itemId === '5') {
      const labels: Record<string, string> = {
        '01718507828': 'টেকনিক্যাল (১)',
        '01799624848': 'টেকনিক্যাল (২)',
        '01799627540': 'মজার রোড',
        '01799624852': 'সায়েদাবাদ',
        '01742627173': 'হেমায়েতপুর',
        '01799624880': 'সাভার',
        '01799624846': 'আব্দুল্লাহপুর',
        '01799624847': 'উত্তরা',
        '01799624849': 'নন্দী',
        '01799624850': 'মালিবাগ',
        '01799624851': 'গোলাপবাগ',
        '01799624881': 'বাইপাল',
